...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Flate2.swiftmodule/`
...
//      `import Flate2` above would fail at compile time.
//
//   2. The static archive `libFlate2.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Flate2" }` and
//      `flattenPackage = "io.github.kotlinmania.flate2"` configuration in
