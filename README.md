...
Kotlin Multiplatform line-by-line clean-room port of the Rust crate [`flate2`](https://crates.io/crates/flate2).

> **Status: scaffold — porting has not started.** This repo currently contains build infrastructure only. The upstream Rust source for the `flate2` crate will be cloned into `tmp/` (gitignored) when porting begins.
...
Original work copyrighted by the upstream `flate2` authors. Kotlin port copyright (c) 2026 Sydney Renee and The Solace Project.
