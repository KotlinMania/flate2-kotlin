...
package io.github.kotlinmania.flate2.zlib.bufread
...
public object RImpl {
    ...
    public fun newWithCompress(r: R, compression: Compress): ZlibEncoder<R> {
        ZlibEncoder {
            obj: r,
            data: compression,
        }
...
public fun resetEncoderData<R>(zlib: ZlibEncoder<R>): Unit {
    zlib.data.resetUnit
}
...
public fun resetDecoderData<R>(zlib: ZlibDecoder<R>): Unit {
...
object TestModule {
    ...
    private fun decodeExtraDataUnit: Unit {
        ...
        val compressed = {
            var e = write.ZlibEncoder.new(mutableListOf<Any>Unit, Compression.defaultUnit)
        ...
        var decoder = ZlibDecoder.new(compressed.asSliceUnit)
