...
This file is the quick-reference operating contract for flate2-kotlin. The longer
...
flate2-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`flate2`](https://crates.io/crates/flate2). Upstream Rust is the behavioral oracle while the
